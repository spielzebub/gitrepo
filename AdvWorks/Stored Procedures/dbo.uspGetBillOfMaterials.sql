...
BEGIN
    ...
    AS (
        SELECT b.[ProductAssemblyID], b.[ComponentID], p.[Name], b.[PerAssemblyQty], p.[StandardCost], p.[ListPrice], b.BOMLevelNew AS BOMLevel, 0 -- Get the initial list of components for the bike assembly
        ...
        UNION ALL
        SELECT b.[ProductAssemblyID], b.[ComponentID], p.[Name], b.[PerAssemblyQty], p.[StandardCost], p.[ListPrice], b.BOMLevelNew AS BOMLevel, [RecursionLevel] + 1 -- Join recursive member to anchor
        FROM [BOM_cte] cte
