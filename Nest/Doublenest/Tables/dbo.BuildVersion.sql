...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Current version number of the AdventureWorksLT sample database. ', 'SCHEMA', N'dbo', 'TABLE', N'BuildVersion', NULL, NULL
GO
