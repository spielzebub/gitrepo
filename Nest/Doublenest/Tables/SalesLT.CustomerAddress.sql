...
GO
ALTER TABLE [SalesLT].[CustomerAddress] ADD CONSTRAINT [PK_CustomerAddress_CustomerID_AddressID] PRIMARY KEY CLUSTERED  ([CustomerID], [AddressID]) ON [PRIMARY]
GO
ALTER TABLE [SalesLT].[CustomerAddress] ADD CONSTRAINT [AK_CustomerAddress_rowguid] UNIQUE NONCLUSTERED  ([rowguid]) ON [PRIMARY]
GO
