...
GO
ALTER TABLE [SalesLT].[Product] ADD CONSTRAINT [PK_Product_ProductID] PRIMARY KEY CLUSTERED  ([ProductID]) ON [PRIMARY]
GO
ALTER TABLE [SalesLT].[Product] ADD CONSTRAINT [AK_Product_Name] UNIQUE NONCLUSTERED  ([Name]) ON [PRIMARY]
GO
ALTER TABLE [SalesLT].[Product] ADD CONSTRAINT [AK_Product_ProductNumber] UNIQUE NONCLUSTERED  ([ProductNumber]) ON [PRIMARY]
GO
ALTER TABLE [SalesLT].[Product] ADD CONSTRAINT [AK_Product_rowguid] UNIQUE NONCLUSTERED  ([rowguid]) ON [PRIMARY]
GO
